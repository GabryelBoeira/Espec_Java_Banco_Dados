package com.br.espec.utfpr.atividade08;
...
public class Atividade08Application {
	...
	@Bean
	public CommandLineRunner AtividadeApplicationTeste(DepartamentoService departamentoService,
		...
		return (arg) -> {
			...
			log.info("11 - Uma procedure que aumenta o sal�rio de todos os funcion�rios em X porcento, onde X � um n�mero inteiro");
			log.info("---------------------------------------------------------------------------");
			...
			log.info("13 - Uma instru��o de update que troca todos os funcion�rios de um determinado departamento para outro departamento utilizando a anota��o @Modifying");
			log.info("---------------------------------------------------------------------------");
			...
			log.info("14 - Uma instru��o de delete que exclui todos os funcion�rios de um determinado departamento utilizando a anota��o @Modifying");
			log.info("---------------------------------------------------------------------------");
